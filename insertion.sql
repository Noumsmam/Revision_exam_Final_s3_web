-- Insertion de données dans takalo_users
...
-- Insertion de données dans takalo_categorie
...
-- Insertion de données dans takalo_objets
...
-- Insertion de données dans takalo_histobjet
